      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Contact ReBooked Living</h1>
            <p className="text-xl text-muted-foreground">
              Questions about student accommodation? Need help finding NSFAS-accredited housing? We're here to help you find the perfect room.
            </p>
          </div>
              ...
              <Card>
                ...
                <CardContent>
                  <a 
                    ...
                    className="inline-flex items-center gap-3 px-4 py-3 rounded-lg bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 text-white hover:opacity-90 transition-opacity group"
                  >
