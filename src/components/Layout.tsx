          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <div className="mt-6 flex items-center gap-3">
                <a href="https://www.instagram.com/rebookd.living/" target="_blank" rel="noopener noreferrer" className="inline-flex w-10 h-10 rounded-full bg-primary items-center justify-center text-primary-foreground hover:shadow-lg transition-all hover:scale-110" title="Follow us on Instagram">
