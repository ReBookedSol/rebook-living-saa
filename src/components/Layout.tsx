        ...
        <div className="container mx-auto px-4 py-12 md:py-16">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            <div>
              ...
              <div className="mt-6">
                <a href="https://www.instagram.com/rebookd.living/" target="_blank" rel="noopener noreferrer" className="inline-flex w-10 h-10 rounded-full bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 items-center justify-center text-white hover:shadow-lg transition-all hover:scale-110">
